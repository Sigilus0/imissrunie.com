...
AllStrings["en"] = {
    CommonMetadata: {
        HeaderSMTitle: "I MISS RUNIE",
        FooterText: "Not affiliated with Runie or Phase Connect - Past stream data provided by Holodex - {0}",
        FooterSourceLink: "Source",
        FooterStreamerLink: "Runie Ch. ルニ・ルーズ【Phase Connect】"
    },

    Main: {
        PageTitle: "I MISS RUNIE",
        DontMissCaption: "I Don't Miss Runie",
        ImageAlt: "Meme",
        RandomVodLink: "Do your reps",
        ErrorMessageChannelLink: "You can check Runie's channel yourself",
    ...
    VideoBox: {
        ...
        MembersOnlySubtext: "(for Runatics only!)",
        ThumbnailAltText: "Video Thumbnail"
    },

    Reps: {
        PageTitle: "Do your reps!",
        SMMetaDescription: "Get a random Runie VOD to watch!",
